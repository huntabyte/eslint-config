...
/**
 * An extension of the `top-level-function` rule from
 * [eslint-plugin-antfu](https://github.com/antfu/eslint-plugin-antfu) that supports
 * Svelte files.
 */
		...
		return {
			VariableDeclaration(node) {
				if (
					...
					// @ts-expect-error - SvelteScriptElement is not a standard node type
